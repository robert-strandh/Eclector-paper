...
The \cl{}\cite{ansi:common:lisp} \texttt{read} function, usually
referred to as the \emph{reader}, is an essential part of any \cl{}
...
\item[Parsing an editor buffer] As a concrete example of this use
  ...
  code is the reader.  But then, again, it is undesirable for the
  reader to intern symbols in any package, and the analysis must not
  fail for errors such as incorrect package names used as package
  prefixes, incomplete code, or syntax errors in tokens.
